...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.word.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.words.update", [$word->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="arabic_word">{{ trans('cruds.word.fields.arabic_word') }}</label>
                <input class="form-control {{ $errors->has('arabic_word') ? 'is-invalid' : '' }}" type="text" name="arabic_word" id="arabic_word" value="{{ old('arabic_word', $word->arabic_word) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('english_word') ? 'is-invalid' : '' }}" type="text" name="english_word" id="english_word" value="{{ old('english_word', $word->english_word) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bangla_word') ? 'is-invalid' : '' }}" type="text" name="bangla_word" id="bangla_word" value="{{ old('bangla_word', $word->bangla_word) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $word->description) !!}</textarea>
