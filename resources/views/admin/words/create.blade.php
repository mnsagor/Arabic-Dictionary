    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.words.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('arabic_word') ? 'is-invalid' : '' }}" type="text" name="arabic_word" id="arabic_word" value="{{ old('arabic_word', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('english_word') ? 'is-invalid' : '' }}" type="text" name="english_word" id="english_word" value="{{ old('english_word', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bangla_word') ? 'is-invalid' : '' }}" type="text" name="bangla_word" id="bangla_word" value="{{ old('bangla_word', '') }}" required>
